<?php
    ...
    if(!empty($maxBookings)){
        $banner="<div class='alert alert-danger' style='width: 100%;'><b>Booking not complete.</b> It seems you have reached your maximum amount of bookings this week.</div>";
    }
    if(!empty($invalidRegion)){
        $banner="<div class='alert alert-danger' style='width: 100%;'><b>Booking not complete.</b> It seems the region you are attempting to book in is not your region.</div>";
    }
